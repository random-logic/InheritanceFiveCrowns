...
namespace TMPro
{
    ...
    public class TmpTextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        {
            get { return _mOnCharacterSelection; }
            set { _mOnCharacterSelection = value; }
        }
        [SerializeField]
        private CharacterSelectionEvent _mOnCharacterSelection = new CharacterSelectionEvent();
        ...
        {
            get { return _mOnSpriteSelection; }
            set { _mOnSpriteSelection = value; }
        }
        [SerializeField]
        private SpriteSelectionEvent _mOnSpriteSelection = new SpriteSelectionEvent();
        ...
        {
            get { return _mOnWordSelection; }
            set { _mOnWordSelection = value; }
        }
        [SerializeField]
        private WordSelectionEvent _mOnWordSelection = new WordSelectionEvent();
        ...
        {
            get { return _mOnLineSelection; }
            set { _mOnLineSelection = value; }
        }
        [SerializeField]
        private LineSelectionEvent _mOnLineSelection = new LineSelectionEvent();
        ...
        {
            get { return _mOnLinkSelection; }
            set { _mOnLinkSelection = value; }
        }
        [SerializeField]
        private LinkSelectionEvent _mOnLinkSelection = new LinkSelectionEvent();
