...
namespace TMPro.Examples
{
    ...
    public class TmpTextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            _mTransform = _mTextComponent.transform;

            // Get a reference to the text object's textInfo
            _mTextInfo = _mTextComponent.textInfo;
            ...
            _mScaleMultiplier = _mTextComponent.GetType() == typeof(TextMeshPro) ? 1 : 0.1f;
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < characterCount; i++)
            {
                ...
                bool isCharacterVisible = i < _mTextComponent.maxVisibleCharacters &&
                                          characterInfo.lineNumber < _mTextComponent.maxVisibleLines &&
                                          i >= _mTextComponent.firstVisibleCharacter;

                if (_mTextComponent.overflowMode == TextOverflowModes.Page)
                    isCharacterVisible = isCharacterVisible && characterInfo.pageNumber + 1 == _mTextComponent.pageToDisplay;
        ...
        void DrawWordBounds()
        {
            for (int i = 0; i < _mTextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    bool isCharacterVisible = characterIndex > _mTextComponent.maxVisibleCharacters ||
                                              currentCharInfo.lineNumber > _mTextComponent.maxVisibleLines ||
                                             (_mTextComponent.overflowMode == TextOverflowModes.Page && currentCharInfo.pageNumber + 1 != _mTextComponent.pageToDisplay) ? false : true;
        ...
        void DrawLineBounds()
        {
            ...
            for (int i = 0; i < lineCount; i++)
            {
                ...
                bool isLineVisible = (lineInfo.characterCount == 1 && (firstCharacterInfo.character == 10 || firstCharacterInfo.character == 11 || firstCharacterInfo.character == 0x2028 || firstCharacterInfo.character == 0x2029)) ||
                                      i > _mTextComponent.maxVisibleLines ||
                                     (_mTextComponent.overflowMode == TextOverflowModes.Page && firstCharacterInfo.pageNumber + 1 != _mTextComponent.pageToDisplay) ? false : true;
        ...
        void DrawBounds()
        {
            Bounds meshBounds = _mTextComponent.bounds;

            // Get Bottom Left and Top Right position of each word
            Vector3 bottomLeft = _mTextComponent.transform.position + meshBounds.min;
            Vector3 topRight = _mTextComponent.transform.position + meshBounds.max;
        ...
        void DrawTextBounds()
        {
            Bounds textBounds = _mTextComponent.textBounds;

            Vector3 bottomLeft = _mTextComponent.transform.position + (textBounds.center - textBounds.extents);
            Vector3 topRight = _mTextComponent.transform.position + (textBounds.center + textBounds.extents);
